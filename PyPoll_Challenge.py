...
file_to_load = os.path.join(r"C:\Users\Samantha\repos\election_analysis\Resources", "election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join(r"C:\Users\Samantha\repos\election_analysis\Analysis", "election_analysis.txt")
